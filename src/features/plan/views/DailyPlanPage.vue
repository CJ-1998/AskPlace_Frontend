...
import DailyPlanView from '@/features/plan/views/DailyPlanView.vue'
...
<template>
  <div class="min-h-screen bg-slate-50 pb-20">
    <div class="max-w-3xl mx-auto"> <!-- Removed px-4 py-8 to allow full width map if needed, but keeping for now -->
      ...
      <!-- Footer Navigation (Day Pagination) - Keeping this in the Page, not the View, as it's navigation -->
